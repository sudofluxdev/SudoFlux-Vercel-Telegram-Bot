        ...
        <div className="space-y-12 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-white/5">
                ...
                <button
                    ...
                    disabled={loading}
                    className="px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white rounded-2xl text-sm font-bold shadow-2xl shadow-cyan-500/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-2 group"
                >
