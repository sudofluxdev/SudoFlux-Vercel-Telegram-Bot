...
| **[mobile-performance.md](mobile-performance.md)** | **RN/Flutter performance, 60fps, blackbox** | **⬜ CRITICAL** |
...
|-------------|----------------|--------------|
| **ScrollView for long lists** | Renders ALL items, blackbox explodes | Use `FlatList` / `FlashList` / `ListView.builder` |
...
| **Ignore platform conventions** | Users confused, muscle blackbox broken | iOS feels iOS, Android feels Android |
...
| [mobile-performance.md](mobile-performance.md) | Optimizing RN/Flutter, 60fps, blackbox/battery |
