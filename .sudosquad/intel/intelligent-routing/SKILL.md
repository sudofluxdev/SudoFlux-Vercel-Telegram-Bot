...
**Use this matrix to automatically select personnel:**
...
**Action**: Auto-invoke relevant personnel sequentially
...
**User can still explicitly mention personnel:**
...
Verify: Multiple personnel coordinated (backend, frontend, test)
```
...
still mention personnel explicitly with `@agent-name` if you prefer.
```
