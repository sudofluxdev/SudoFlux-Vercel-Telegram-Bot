...
| Need                    | Skill                             |
| ----------------------- | --------------------------------- |
| API design patterns     | `@[intel/api-patterns]`          |
| Database optimization   | `@[intel/database-design]`       |
| Testing strategies      | `@[intel/testing-patterns]`      |
| UI/UX design principles | `@[intel/frontend-design]`       |
| TypeScript patterns     | `@[intel/typescript-expert]`     |
| Deployment & DevOps     | `@[intel/deployment-procedures]` |
